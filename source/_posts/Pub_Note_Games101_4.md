...
补充上节课的内容：
![image.png](/images/Pub_Note_Games101_4/image.png)
...
用齐次坐标表示三维空间中的点或向量：
![image-1.png](/images/Pub_Note_Games101_4/image-1.png)
![image-2.png](/images/Pub_Note_Games101_4/image-2.png)
...
![image-3.png](/images/Pub_Note_Games101_4/image-3.png)

绕任意轴的旋转矩阵很难写，但是我们可以先从简单的开始，绕 x, y, z 轴的旋转矩阵：
![image-4.png](/images/Pub_Note_Games101_4/image-4.png)
...
![image-5.png](/images/Pub_Note_Games101_4/image-5.png)
...
![image-6.png](/images/Pub_Note_Games101_4/image-6.png)
...
推导：
![image-7.png](/images/Pub_Note_Games101_4/image-7.png)
![image-8.png](/images/Pub_Note_Games101_4/image-8.png)
![image-9.png](/images/Pub_Note_Games101_4/image-9.png)
...
![image-10.png](/images/Pub_Note_Games101_4/image-10.png)
...
怎么定义 view 的角度：
![image-11.png](/images/Pub_Note_Games101_4/image-11.png)

- 一方面是向哪个方向看，即 look at
- 另一方面确定有没有一个自身的旋转，我们用 up direction 来定义

就像在摄影棚一样，把相机固定在一个位置和角度，在图形学中我们总是希望把相机放在原点，往负 z 方向看，y 轴向上。
![image-12.png](/images/Pub_Note_Games101_4/image-12.png)
具体怎么做呢：
![image-13.png](/images/Pub_Note_Games101_4/image-13.png)
y 跟 z 对齐了，x 自然而然也就对上了

表示为矩阵形式：
![image-14.png](/images/Pub_Note_Games101_4/image-14.png)
...
![image-15.png](/images/Pub_Note_Games101_4/image-15.png)

- 左边正交投影的平行线还是平行的
- 但右边透视投影的就不是了，延长后会相交在一个点上
- 正交投影更多用于工程制图

![image-16.png](/images/Pub_Note_Games101_4/image-16.png)

### Orthographic Projection

用一种简单的方式来描述：
![image-17.png](/images/Pub_Note_Games101_4/image-17.png)
...
图形学中更正式的说法：
![image-18.png](/images/Pub_Note_Games101_4/image-18.png)

把 xyz3 个轴的范围都映射到-1 到 1 的立方体上，这个立方体叫做 canonical cube。

![image-19.png](/images/Pub_Note_Games101_4/image-19.png)

- 正式的作法，我们先做平移，然后再缩放

把这个变换写成矩阵形式：
![image-20.png](/images/Pub_Note_Games101_4/image-20.png)

- 首先是从将中点平移到原点
- 然后缩放到-1 到 1 的范围，就是 2

![image-21.png](/images/Pub_Note_Games101_4/image-21.png)
...
![image-22.png](/images/Pub_Note_Games101_4/image-22.png)
![image-23.png](/images/Pub_Note_Games101_4/image-23.png)

- 欧式几何里平行线永不相交，但在透视投影里会相交，这是为什么？难道欧拉错了？
- 欧式几何指的是在同一个平面里，但是在透视投影里涉及到不同的平面和角度

在具体说透视投影之前，我们需要回顾齐次坐标，这个对于透视投影很重要：
![image-24.png](/images/Pub_Note_Games101_4/image-24.png)

怎么做透视投影呢：
![image-25.png](/images/Pub_Note_Games101_4/image-25.png)
...
挤压怎么做：
![image-26.png](/images/Pub_Note_Games101_4/image-26.png)

- 可以根据侧面图的相似三角形得到高度跟深度的一个比例的关系
- 对于 x 也是同样的道理

那么现在我们给定任意一个 x y z，我们都能得到它的新的坐标 x' y'，只是 z 还不知道：
![image-27.png](/images/Pub_Note_Games101_4/image-27.png)
![image-28.png](/images/Pub_Note_Games101_4/image-28.png)
目标是算出左边的矩阵是什么。

![image-29.png](/images/Pub_Note_Games101_4/image-29.png)

- 近平面上的点都不变
- 远平面上的点的 z 轴不变（远平面上的中心点的 z 值不变）

![image-30.png](/images/Pub_Note_Games101_4/image-30.png)
...
![image-31.png](/images/Pub_Note_Games101_4/image-31.png)
...
![image-32.png](/images/Pub_Note_Games101_4/image-32.png)
