...
在正交投影中如何定义视野的长方体呢？
![image.png](/images/Pub_Note_Games101_5/image.png)
...
![image-1.png](/images/Pub_Note_Games101_5/image-1.png)

### What's After MVP?

![image-2.png](/images/Pub_Note_Games101_5/image-2.png)
...
![image-3.png](/images/Pub_Note_Games101_5/image-3.png)
...
什么叫屏幕空间呢？
![image-5.png](/images/Pub_Note_Games101_5/image-5.png)

- 其实就是在屏幕中建立一个坐标系，可能会有各种不同的定义，我们这里把左下角定义为原点，向右是 x，向上是 y。
- 一个像素的中心在哪里呢？其实是在 x 加 0.5 和 y 加 0.5 上。

然后我们需要把之前的-1~1 的三次方的立方体映射到屏幕上
![image-4.png](/images/Pub_Note_Games101_5/image-4.png)

- 关于 z 值的处理，暂时先不管，后面会讲到。
- x 跟 y 的转换就很简单了

这里相当于我们获取了场景的一张虚拟的照片，但它还是空间中描述的一堆三角形，我们要真正的把它变为像素表示的图，也就是光栅化的过程。
![image-6.png](/images/Pub_Note_Games101_5/image-6.png)

## Drawing Machines

在说光栅化之前，我们来看一些绘制的机器：

![image-7.png](/images/Pub_Note_Games101_5/image-7.png)

![image-8.png](/images/Pub_Note_Games101_5/image-8.png)
...
示波器：
![image-9.png](/images/Pub_Note_Games101_5/image-9.png)
早期的很多电脑显示器就是这样
![image-10.png](/images/Pub_Note_Games101_5/image-10.png)
可以形成各种不同的曲线
...
- 下面是红白机上的 space invaders：
  ![image-13.png](/images/Pub_Note_Games101_5/image-13.png)

### LCD

现在的主要显示设备是 lcd：
![image-14.png](/images/Pub_Note_Games101_5/image-14.png)
现在的手机屏幕分辨率已经超过了人眼的分辨率，这种屏幕叫视网膜屏幕。

lcd 叫做液晶显示器，它是利用液晶的原理来控制一个像素，通过不同排布影响光的极化（光的偏振方向）。
![image-15.png](/images/Pub_Note_Games101_5/image-15.png)
...
![image-16.png](/images/Pub_Note_Games101_5/image-16.png)

### E-Ink

![image-17.png](/images/Pub_Note_Games101_5/image-17.png)
...
![image-18.png](/images/Pub_Note_Games101_5/image-18.png)
Triangle Meshes（三角形网格）：
![image-19.png](/images/Pub_Note_Games101_5/image-19.png)
复杂图形可以用很多的三角形来表示，为什么我们认为三角形在图形学中会得到广泛应用呢？
![image-20.png](/images/Pub_Note_Games101_5/image-20.png)
...
![image-22.png](/images/Pub_Note_Games101_5/image-22.png)
...
![image-24.png](/images/Pub_Note_Games101_5/image-24.png)
![image-23.png](/images/Pub_Note_Games101_5/image-23.png)
![image-25.png](/images/Pub_Note_Games101_5/image-25.png)

这个 inside 的函数要怎么确定呢，这要用到我们之前提到的叉积的概念。
![image-26.png](/images/Pub_Note_Games101_5/image-26.png)
...
![image-27.png](/images/Pub_Note_Games101_5/image-27.png)

如果每行都从三角形的左边到右边，这样其实可以做到不多计算任何一个像素：
![image-28.png](/images/Pub_Note_Games101_5/image-28.png)

现实中的 LCD 屏幕：
![image-29.png](/images/Pub_Note_Games101_5/image-29.png)

左边：一个像素其实由红绿蓝三个不同的条组成
右边：绿色的点其实要比这个红色和蓝色的都要多，因为人眼对绿色最敏感，很多相机也是这么设计的，人眼会更舒服。

![image-31.png](/images/Pub_Note_Games101_5/image-31.png)

我们最后得到了一个这样的图形，它的形状基本上跟三角形一致，但是可以看到有很明显的锯齿：
![image-30.png](/images/Pub_Note_Games101_5/image-30.png)
