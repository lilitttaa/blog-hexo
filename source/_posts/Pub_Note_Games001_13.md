...
你只要把前面每一次前面乘以一个 0.5 的话

那么这个这个时候 X 等于 B 这个矩阵方程
...
那么 JQUITRATION 它的这个啊近似啊

这个对角矩阵近似 A 矩阵的效果就会越好
...
那就是这个 A 矩阵它是一个对称半正定的矩阵

它并不要求 A 矩阵是对角占优的

他只要求 A 矩阵是这个对称半正定的矩阵
