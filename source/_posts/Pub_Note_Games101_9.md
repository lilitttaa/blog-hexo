...
为什么要对三角形内部的点进行插值？
![image.png](/images/Pub_Note_Games101_9/image.png)
...
![image-1.png](/images/Pub_Note_Games101_9/image-1.png)
...
![image-2.png](/images/Pub_Note_Games101_9/image-2.png)

- a 点可以写作$\alpha a + 0b + 0c$，所以 a 点的重心坐标是(1, 0, 0)。
- b 点是(0, 1, 0)，c 点是(0, 0, 1)。

重心坐标有个定义，它其实是可以通过面积比求出来的
![image-3.png](/images/Pub_Note_Games101_9/image-3.png)

- 顶点它对面的三角形的面积占整个三角形的面积的比例

那么根据这个定义就能得到一个特殊的点，就是三角形自己的重心
![image-4.png](/images/Pub_Note_Games101_9/image-4.png)
...
![image-5.png](/images/Pub_Note_Games101_9/image-5.png)
推导过程：
...
![image-6.png](/images/Pub_Note_Games101_9/image-6.png)
...
![image-7.png](/images/Pub_Note_Games101_9/image-7.png)
...
![image-8.png](/images/Pub_Note_Games101_9/image-8.png)
...
![image-9.png](/images/Pub_Note_Games101_9/image-9.png)
先找到周围四个采样点
![image-10.png](/images/Pub_Note_Games101_9/image-10.png)
![image-11.png](/images/Pub_Note_Games101_9/image-11.png)

- 在垂直或者水平方向，用两个点进行插值只是线性插值
- 但是在两个方向上都进行插值，就是双线性插值
- 这两个方向插值顺序不影响结果

![image-12.png](/images/Pub_Note_Games101_9/image-12.png)
...
![image-13.png](/images/Pub_Note_Games101_9/image-13.png)

- 近处有锯齿，远处有摩尔纹

![image-14.png](/images/Pub_Note_Games101_9/image-14.png)
...
![image-15.png](/images/Pub_Note_Games101_9/image-15.png)

- 每个像素内有 512 个采样点，然后取平均值

但是这样会导致运算量大，我们首先来分析一下这个问题：
![image-16.png](/images/Pub_Note_Games101_9/image-16.png)
...
这里简单提一下：
![image-17.png](/images/Pub_Note_Games101_9/image-17.png)
...
![image-18.png](/images/Pub_Note_Games101_9/image-18.png)

- Mip Map 是一个经典的图形学概念，它允许做范围查询
- 速度快，但是是近似的。它只能做近似的正方形范围查询，其他形状不行。

![image-19.png](/images/Pub_Note_Games101_9/image-19.png)

- MipMap 就是从一张图生成一系列图，每一层都是上一层缩小一倍
- 一直到第 Log2 层，$\log_2{128} = 7$，算上第 0 层，总共有 8 层
  ![image-20.png](/images/Pub_Note_Games101_9/image-20.png)
...
![image-21.png](/images/Pub_Note_Games101_9/image-21.png)
![image-22.png](/images/Pub_Note_Games101_9/image-22.png)

- 分别在 x 和 y 方向上做微分（在屏幕上 x/y 方向上移动一个单位，纹理上移动多少单位）

可视化展示 MipMap 的效果：
![image-23.png](/images/Pub_Note_Games101_9/image-23.png)

- 远处用到更深的层，近处用到浅的层

但是现在有一个问题，就是 MipMap 也是离散的，所以还是会有不连续的问题。比如我想查第 1.8 层，要怎么办呢？
![image-24.png](/images/Pub_Note_Games101_9/image-24.png)
我们跟之前的 bilinear interpolation 一样，先查第一层，再查第二层，然后再这两层之间再做一次线性插值，这样就是三线性插值（trilinear interpolation）。
这样就能得到一个连续的值：
![image-25.png](/images/Pub_Note_Games101_9/image-25.png)

对比 supersampling：
![image-26.png](/images/Pub_Note_Games101_9/image-26.png)
![image-27.png](/images/Pub_Note_Games101_9/image-27.png)
...
![image-28.png](/images/Pub_Note_Games101_9/image-28.png)
![image-29.png](/images/Pub_Note_Games101_9/image-29.png)
在像素上的一块区域对应到纹理上通常是一个矩形区域，各项异性过滤允许我们对这种长条形区域做一个快速的范围查询，而不用限制在一个正方形区域内。
![image-30.png](/images/Pub_Note_Games101_9/image-30.png)
...
![image-31.png](/images/Pub_Note_Games101_9/image-31.png)
